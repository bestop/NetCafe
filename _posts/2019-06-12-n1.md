...
线刷方法如下，首先要准备USB对公线一条，WEBPAD大的2.2线刷包和USB_Burning_Tool刷机工具。 </BR>    

1.先把USB对公线链接到电脑USB口与N1的第二个口（靠HDMI口），N1不要通电；</BR>     
2.打开USB_Burning_Tool，导入固件WEBPAD大的2.2的线刷包，验证通过后，出现开始字样；</BR>     
3.勾选擦除FLASH，不要勾选擦除bootloader，USB_Burning_Tool点击开始运行刷机，3秒钟内速度让N1通电；</BR>     
4.USB_Burning_Tool开始正常识别N1线刷模式，刷机开始； </BR>    
5.烧录完成后，拔电重启，N1恢复了原来的样子，可以正常ADB连接，进入线刷，重新安装ARMBIAN。 </BR>    
